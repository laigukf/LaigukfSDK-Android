# 来鼓移动应用 SDK 3.0 for Android 开发文档

## ScreenShot
![](https://github.com/laigukf/LaigukfSDK-Android/blob/master/image/screenshot.png)
...
implementation 'com.laigu:laigusdk:3.6.2.1'
...
> 设置监听 LGConversationActivity 生命周期的回调接口

``` java
LGConfig.setActivityLifecycleCallback(new LGSimpleActivityLifecycleCallback() {
});
```
