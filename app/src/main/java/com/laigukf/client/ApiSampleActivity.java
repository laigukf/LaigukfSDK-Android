...
import com.laigukf.core.LGScheduleRule;
...
import com.laigukf.sdk.controller.ControllerImpl;
...
public class ApiSampleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lgManager = LGManager.getInstance(this);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.set_current_client_id_online_btn:
                LGConfig.registerController(new ControllerImpl(this));
                Intent intent = new LGIntentBuilder(this).build();
                startActivity(intent);
                break;
            // 使用指定 来鼓顾客id 上线
            case R.id.set_meiqia_client_id_online_btn:
                showDialog("输入来鼓 ID", new EditDialogOnClickListener() {
                    @Override
                    public void onInput(String clientId) {
                        if (!TextUtils.isEmpty(clientId)) {
                            Intent intent = new LGIntentBuilder(ApiSampleActivity.this)
            ...
            case R.id.get_new_meiqia_id_btn:
                LGManager.getInstance(this).createMQClient(new OnGetLGClientIdCallBackOn() {
                    @Override
                    ...
                    public void onInput(String agentId) {
                        if (!TextUtils.isEmpty(agentId)) {
                            Intent intent = new LGIntentBuilder(ApiSampleActivity.this)
                                    ...
                                    .setScheduleRule(LGScheduleRule.REDIRECT_ENTERPRISE.REDIRECT_ENTERPRISE)
                                    .build();
                            startActivity(intent);
                            updateId();
                        }
                    ...
                    public void onInput(String groupId) {
                        if (!TextUtils.isEmpty(groupId)) {
                            Intent intent = new LGIntentBuilder(ApiSampleActivity.this)
                                    ...
                                    .setScheduleRule(LGScheduleRule.REDIRECT_ENTERPRISE)
                                    .build();
                            startActivity(intent);
                        }
                    }
            ...
            case R.id.set_client_info:
                LGConfig.isShowClientAvatar = true;
            ...
            case R.id.get_unread_message_btn:
                ...
                unreadDialog.setButton(DialogInterface.BUTTON_POSITIVE, "确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        LGManager.getInstance(ApiSampleActivity.this).getUnreadMessages(new OnGetMessageListCallback() {
                            @Override
                            public void onSuccess(List<LGMessage> messageList) {
            ...
            case R.id.set_client_offline_btn:
                LGManager.getInstance(this).setClientOffline();
                break;
            // 结束当前对话
            case R.id.end_conversation_btn:
                LGManager.getInstance(this).endCurrentConversation(new OnEndConversationCallback() {
                    @Override
    ...
    private void updateId() {
        currentIdTv.setText(lgManager.getCurrentClientId());
    }
    ...
    private void showDialog(String title, final EditDialogOnClickListener editDialogOnClickListener) {
        final Dialog inputDialog = new Dialog(this, R.style.LGDialog);
        ...
        inputDialog.findViewById(R.id.tv_input_confirm).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LGUtils.closeKeyboard(inputDialog);
                inputDialog.dismiss();
                editDialogOnClickListener.onInput(valueEt.getText().toString());
            }
        });
        inputDialog.show();
        LGUtils.openKeyboard(valueEt);
    }
